...
// ---- 常量 ----
const PLAY_RECORDS_KEY = 'unicorntv_play_records';
const FAVORITES_KEY = 'unicorntv_favorites';
const SEARCH_HISTORY_KEY = 'unicorntv_search_history';

// 缓存相关常量
const CACHE_PREFIX = 'unicorntv_cache_';
